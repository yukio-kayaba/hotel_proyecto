...
<?php include("layouts/head.php"); ?>
    ...
    <script src="<?php echo url;?>/view/js/create_count.js" defer></script>
</head>
        ...
        <section class="imagen_dato " style="width:100%">
            ...
            <div class="formulario">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="dni_registrar" class="input" type="number" placeholder="Ingrese su DNI">
                    </div>
                    </div>
                    ...
                    <div class="control has-icons-left has-icons-right">
                        <input id="correo_registrar" class="input" type="email" placeholder="ejemplo@gmail.com">
                    ...
                    <div class="control has-icons-left has-icons-right">
                        <input id="contra_registrar" class="input" type="password" placeholder="Ingrese su apellido">
                        <span class="icon is-small is-left">
                    ...
                    <div class="control">
                        <button id="boton_registrarse" class="button is-link">Crear cuenta !!</button>
                    </div>
                    <div class="control">
